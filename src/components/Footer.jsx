        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li><a href="#recipes">{t.recipes}</a></li>
              <li><a href="#popular">{t.popular}</a></li>
              <li><a href="#categories">{t.footerCategories}</a></li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li><a href="#meat">{t.meatSeafood}</a></li>
              <li><a href="#healthy">{t.healthyDiet}</a></li>
              <li><a href="#holidays">{t.holidays}</a></li>
              <li><a href="#cuisine">{t.cuisine}</a></li>
            </ul>
          </div>
